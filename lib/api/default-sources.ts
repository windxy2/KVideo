...
// Default subscriptions to load on first visit
export const DEFAULT_SUBSCRIPTIONS: SourceSubscription[] = [
  {
    "id": "sub_1770512142458_mjii6f",
    "name": "系统预设源 1",
    "url": "https://raw.githubusercontent.com/gaotianliuyun/gao/master/XYQ.json",
    "lastUpdated": 0,
    "autoRefresh": true
  },
  {
    "id": "sub_1770690458992_6881bd",
    "name": "系统预设源 2",
    "url": "https://github.com/windxy2/KVideo/blob/main/1.json",
    "lastUpdated": 0,
    "autoRefresh": true
  }
];
